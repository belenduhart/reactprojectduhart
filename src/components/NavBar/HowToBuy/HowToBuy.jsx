    ...
    return (
        ...
        <div className="htbdiv">
            ...
            <ul>
                ...
                <li>Selecciona entre las opciones de envio:
                    <dt>Retiro por el local. <b>Avellaneda 3738, Flores, CABA. De Lunes a Viernes de 9 a 16hs.</b></dt>
                    <dt>Envio a domicilio, y completa tus datos</dt>
                </li>
